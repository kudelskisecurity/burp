...
from burp.models.scanissues import ScanIssue, ScanIssueReturnedGetNone, ScanIssueReturnedGetMulti, ScanIssueReturnedPost
...
class ScanIssues(Base):
    ...
    def get(self, url: Optional[str] = None) -> Union[Iterable[ScanIssueReturnedGetNone],
        ...
        if url is not None:
            scan_issue_class = ScanIssueReturnedGetMulti
